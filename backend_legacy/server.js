...
require('./workers/provisioningWorker');
require('./workers/mediacpSyncWorker');
require('./workers/mediacpCron');
...
(async function bootstrap() {
  const adminCount = await prisma.user.count({ where: { tenantId: null } });
  ...
  process.stdout.write(`[init] Super Admin created: ${email}\n`);
})();
...
app.use('/api/mobile/v1', require('./routes/mobile'));
